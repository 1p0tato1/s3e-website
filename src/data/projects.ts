...
export const trustedClients: TrustedClient[] = [
  ...
  { id: 'foire-sousse', file: 'foire-sousse.png', url: 'https://www.fis-sousse.tn/' },
  ...
  {
    id: 'centre-carthage-medical',
    file: 'centre-international-carthage-medical.webp',
    url: 'https://carthagemedical.com.tn/',
  },
  ...
  {
    id: 'kaschke-components',
    file: 'kaschke_components_tunisie.jpeg',
    url: 'https://bourns.com/products/magnetic-products/kaschke-components/kaschke-capabilities',
  },
